...
<div class=" py-1 px-4 hover:bg-blue-500 hover:text-white cursor-pointer flex items-center gap-2">
...
<div class=" text-sm font-semibold rounded-full py-1 px-4 bg-blue-400 text-white cursor-pointer hover:bg-blue-500 active:scale-95 max-w-32 overflow-hidden flex items-center gap-2">
    <i class="fa-regular fa-folder-open"></i>
    <span class=" truncate">First Folder</span>
</div>
<div class=" text-sm font-semibold rounded-full py-1 px-4 bg-blue-500 text-white cursor-pointer hover:bg-blue-500 active:scale-95 max-w-32 overflow-hidden flex items-center gap-2">
    <i class="fa-regular fa-folder-open"></i>
